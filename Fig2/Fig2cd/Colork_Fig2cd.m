...
p(1)=plot(y(1:1:end,5),y(1:1:end,2),'LineWidth',2,'Color',[0 0 1]);
hold on
p(2)=plot(y(1:1:end,5),y(1:1:end,4),'LineWidth',2,'Color','red');
hold on
...
for i=1:m2
    if filen(i,2)<0
        ...
        if filen(i,1)==3
            plot(xy(1:2:end,4),xy(1:2:end,6+va),'.','Color',[0.35 0.35 0.35],'Markersize',24);
            hold on
            plot(xy(1:2:end,4),xy(1:2:end,6+va+dim),'.','Color',[0.35 0.35 0.35],'Markersize',24);
            hold on
        elseif filen(i,1)==4
            plot(xy(1:2:end,4),xy(1:2:end,6+va),'ok');
            hold on
...
YTick= [0:0.1:0.3];
 ...
 legend(p([1 2]),{'$~H_1~(\mu=-0.0001)$','$~H_2~(\mu=-0.0001)$'},'Fontsize',22,'Interpreter','latex','Box','off', 'Position',[0.0694113645387555 0.565317919075146 0.221569917367087 0.402742016563781],...
    'Interpreter','latex',...
    'FontSize',15);
...
p(5)=plot(y(1:1:end,5),y(1:1:end,2),'LineWidth',2,'Color',[0 0 1]);
hold on
p(6)=plot(y(1:1:end,5),y(1:1:end,4),'LineWidth',2,'Color','red');
hold on
