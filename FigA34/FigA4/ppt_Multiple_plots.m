...
hold on
 ...
 y1=linspace(0,7557,10);
 y2=0.2*ones(1,10);
 
 plot(y1,y2,'k');  hold on
 
 y3=linspace(0.198,0.202,10);
 y4=0*ones(1,10);
...
ylabel('$V_{i}$','interpreter','latex','Fontsize',28,'rotation',0)
...
XTick = [0:5000:15000];
  set(gca,'xtick',XTick,'ytick',YTick)
   xticklabels({'1600','2600','3600','4600'})
